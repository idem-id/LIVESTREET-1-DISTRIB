...
$config['module']['blog']['encrypt'] = 'BWi8qp5KwldQOzUD';                      // Ключ XXTEA шифрования идентификаторов в ссылках приглашения в блоги
...
// Модуль Security
$config['module']['security']['hash'] = "F9xh05VCOeLvrYX7";                     // "примесь" к строке, хешируемой в качестве security-кода
...
$config['head']['default']['js'] = array(
  ...
  "___path.root.engine_lib___/external/highlight.js/highlight.pack.js",
