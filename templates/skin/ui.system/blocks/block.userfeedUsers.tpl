  ...
  <section class="panel panel-default block block-type-activity">
    <div class="panel-body">
      ...
      <div class="block-content">
        <p class="small text-muted">{$aLang.userfeed_settings_note_follow_user}</p>
        ...
        <div class="stream-settings-userlist">
          <div class="input-group">
            ...
            <span class="input-group-btn">
              <a title="{$aLang.userfeed_block_users_append}" href="javascript:ls.userfeed.appendUser()" class="btn btn-default"><i class="fa fa-user-plus fa-fw"></i></a>
            </span>
          </div>
  ...
  {if count($aUserfeedFriends)}
    <section class="panel panel-default block block-type-activity">
      <div class="panel-body">
        ...
        <div class="block-content">
          <p class="small text-muted">{$aLang.userfeed_settings_note_follow_friend}</p>
