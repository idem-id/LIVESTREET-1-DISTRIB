{if {cfg name='custom.block.blogs'}}
  <section class="panel panel-default block" id="block_blogs">
    <div class="panel-body">

      <header class="block-header">
        <div class="block-update js-block-blogs-update btn btn-default btn-sm"><i class="fa fa-refresh"></i></div>
