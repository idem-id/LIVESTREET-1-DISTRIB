  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4 hidden-xs">
        {if $oUserCurrent}
          <a title="{$aLang.block_create}" href="{router page='topic'}add/" class="btn btn-success btn-write pull-right" id="modal_write_show"><i class="fa fa-plus-square fa-fw"></i></a>
        {/if}
