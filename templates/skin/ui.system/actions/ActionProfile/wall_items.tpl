  ...
  <div id="wall-item-{$oWall->getId()}" class="js-wall-item comment-wrapper">
    <div class="comment">
      ...
      <ul class="list-unstyled list-inline small comment-info">
        ...
        <li class="{if $oWallUser->isOnline()}text-success{else}text-danger{/if} comment-author-status">
          <i title="{if $oWallUser->isOnline()}{$aLang.user_status_online}{else}{$aLang.user_status_offline}{/if}" class="fa fa-power-off"></i>
        </li>
        <!-- / online-offline status -->
