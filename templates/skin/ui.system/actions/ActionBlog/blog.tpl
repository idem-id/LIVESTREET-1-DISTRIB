...
<div class="blog">
  <header class="blog-header">
    ...
    <img src="{$oBlog->getAvatarPath(48)}" alt="{$oBlog->getTitle()|escape:'html'}" class="avatar" />
    ...
    {if $oUserCurrent and ($oUserCurrent->getId()==$oBlog->getOwnerId() or $oUserCurrent->isAdministrator() or $oBlog->getUserIsAdministrator() )}
      <ul class="small list-unstyled list-inline actions">
        <li><a href="{router page='blog'}edit/{$oBlog->getId()}/" title="{$aLang.blog_edit}" class="actions-edit"><i class="fa fa-pencil fa-fw"></i></a></li>
        <li>
          {if $oUserCurrent->isAdministrator()}
            <a href="#" title="{$aLang.blog_delete}" id="blog_delete_show" class="actions-delete"><i class="fa fa-trash-o fa-fw"></i></a>
          {else}
            <a href="{router page='blog'}delete/{$oBlog->getId()}/?security_ls_key={$LIVESTREET_SECURITY_KEY}" title="{$aLang.blog_delete}" onclick="return confirm('{$aLang.blog_admin_delete_confirm}');" class="actions-delete"><i class="fa fa-trash-o fa-fw"></i></a>
          {/if}
        </li>
      </ul>
    {/if}
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <span class="user-avatar">
            <a href="{$oUserOwner->getUserWebPath()}"><img src="{$oUserOwner->getProfileAvatarPath(24)}" alt="{$oUserOwner->getLogin()}" /></a>
