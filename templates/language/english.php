...
return array(
  ...
  'user_not_found' => 'User <strong>%%login%%</strong> wasn\'t not found',
  'user_not_found_by_id' => 'User <strong>#%%id%%</strong> wasn\'t not found',
  ...
  'settings_profile_mail_change_ok' => 'Your email is changed to <strong>%%mail%%</strong>',
  ...
  'talk_user_in_blacklist' => 'User <strong>%%login%%</strong> blacklisted your messages',
  ...
  'talk_blacklist_add_ok' => 'User <strong>%%login%%</strong> added to blacklist',
  'talk_blacklist_user_already_have' => 'User <strong>%%login%%</strong> already in your black list',
  'talk_blacklist_delete_ok' => 'User <strong>%%login%%</strong> removed from blacklist',
  'talk_blacklist_user_not_found' => 'User <strong>%%login%%</strong> is not in your black list',
  ...
  'talk_speaker_delete_ok' => 'Member <strong>%%login%%</strong> deleted successfully',
  'talk_speaker_user_not_found' => 'User <strong>%%login%%</strong> is not a member of this message',
  'talk_speaker_user_already_exist' => ' <strong>%%login%%</strong> is a member of this message already',
  'talk_speaker_add_ok' => 'User <strong>%%login%%</strong> added successfully',
  'talk_speaker_delete_by_self' => 'Member <strong>%%login%%</strong> deleted this message',
  ...
  'plugins_activation_requires_error' => 'Plugin requires activated <strong>%%plugin%%</strong> plugin',
