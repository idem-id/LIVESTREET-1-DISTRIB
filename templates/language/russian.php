...
return array(
  ...
  'blog_admin_users_bun' => 'заблокированный',
  ...
  'blog_user_already_invited' => 'Пользователю %%login%% уже отправлено приглашение',
  'blog_user_already_exists' => 'Пользователь %%login%% уже состоит в блоге',
  'blog_user_already_reject' => 'Пользователь %%login%% отклонил приглашение',
  ...
  'topic_create_blog_error_unknown' => 'Пытаетесь опубликовать топик в неизвестный блог?',
  'topic_create_blog_error_nojoin' => 'Вы не состоите в этом блоге!',
  'topic_create_blog_error_noacl' => 'Вы еще недостаточно окрепли, чтобы публиковать в этот блог',
  ...
  'user_stats_sex_other' => 'Гендер не указан',
  'user_not_found' => 'Пользователь <strong>%%login%%</strong> не найден',
  'user_not_found_by_id' => 'Пользователь <strong>#%%id%%</strong> не найден',
  ...
  'settings_profile_mail_error_used' => 'Этот e-mail уже занят',
  'settings_profile_mail_notice' => 'Ваш реальный почтовый адрес, на него будут приходить уведомления',
  'settings_profile_mail_change_from_notice' => 'На Вашу старую почту отправлено подтверждение для смены e-mail',
  'settings_profile_mail_change_to_notice' => 'Спасибо! <br/> На Ваш новый e-mail адрес отправлено подтверждение для смены старого e-mail.',
  'settings_profile_mail_change_ok' => 'Ваш e-mail изменен на <strong>%%mail%%</strong>',
  'settings_profile_sex' => 'Гендер',
  ...
  'settings_invite_available_no' => 'У Вас пока нет доступных приглашений',
  ...
  'settings_menu_invite' => 'Приглашения',
  ...
  'talk_user_in_blacklist' => 'Пользователь <strong>%%login%%</strong> не принимает от Вас писем',
  ...
  'talk_blacklist_add_ok' => 'Пользователь <strong>%%login%%</strong> успешно добавлен',
  'talk_blacklist_user_already_have' => 'Пользователь <strong>%%login%%</strong> есть в Вашем black list`е',
  'talk_blacklist_delete_ok' => 'Пользователь <strong>%%login%%</strong> успешно удален',
  'talk_blacklist_user_not_found' => 'Пользователя <strong>%%login%%</strong> нет в Вашем black list`е',
  ...
  'talk_speaker_delete_ok' => 'Участник <strong>%%login%%</strong> успешно удален',
  'talk_speaker_user_not_found' => 'Пользователь <strong>%%login%%</strong> не участвует в разговоре',
  'talk_speaker_user_already_exist' => ' <strong>%%login%%</strong> уже участник разговора',
  'talk_speaker_add_ok' => 'Участник <strong>%%login%%</strong> успешно добавлен',
  'talk_speaker_delete_by_self' => 'Участник <strong>%%login%%</strong> удалил этот разговор',
   ...
   * Админка
   */
  'admin_header' => 'Администрирование',
  ...
  'notify_subject_user_changemail' => 'Подтверждение смены e-mail',
  /**
   * Админка
   */
  'admin_title' => 'Администрирование',
  'admin_comment_restore_tree' => 'Дерево комментариев перестроено',
  'admin_favourites_recalculated' => 'Счетчики избранных пересчитаны',
  'admin_votes_recalculated' => 'Счетчики голосований пересчитаны',
  'admin_topics_recalculated' => 'Количество топиков пересчитано',
  /**
  ...
  'plugins_plugin_activate' => 'Включить',
  'plugins_plugin_deactivate' => 'Отключить',
  ...
  'plugins_activation_requires_error' => 'Для работы плагина необходим активированный плагин <strong>%%plugin%%</strong>',
   ...
   * Системные сообщения
   */
  'system_error_event_args' => 'Некорректное число аргументов при добавлении события',
  'system_error_event_method' => 'Добавляемый метод события не найден',
  ...
  'system_error_cache_type' => 'Неверный тип кэширования',
